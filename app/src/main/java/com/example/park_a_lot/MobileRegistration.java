...
public class MobileRegistration extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edtOTP = findViewById(R.id.Userotp);
        verifyOTPBtn = findViewById(R.id.Verifybutton);
        generateOTPBtn = findViewById(R.id.SendOTP);
        mResend = findViewById(R.id.resendOtp);
                ...
                .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Intent i = new Intent(MobileRegistration.this, VehicleRegistration.class);
                            startActivity(i);
                            finish();
                        } else {
